package org.n27.nutshell.common.presentation.fundamental.color
...
class Background(
    neutral: Color,
    neutralAlternative: Color
) {
    var neutral: Color by mutableStateOf(neutral)
        internal set

    var neutralAlternative: Color by mutableStateOf(neutralAlternative)
        internal set
}
